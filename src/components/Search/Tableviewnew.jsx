...
const Tableviewnew = ({
  ...
  const startOfIndexForHeading = fileData.indexOf(fileData.find((e) => e.B && e.B === THIRD_TABLE_KEYS.START)) + 1;
  ...
  let headerTable = fileData.slice(startOfIndexForHeading, startOfIndexEndHeading);
...
console.log("qqqqqqqqqqqqqqqq",updatedData)
...
// }, [designation])
  ...
  useEffect(() => {
    ...
    if (updatedBehaviourData.length === 0 && quarterlyBehavioural?.length !== undefined) {

      const keys = Array.from(Array(quarterlyBehavioural.LowPotential?.length).keys());
...
console.log("ssssssssssssssssss",dynamicKpiTestTable)
                ...
                return (
                  <>
                    <RenderTestTable
                      ...
                      fullKeys={fullKeys}
                      division={division}
                      dynamicKpiTestTable={dynamicKpiTestTable}
                      setdynamicKpiTestTable={setdynamicKpiTestTable}
                    />
                  </>
                );
              })}
