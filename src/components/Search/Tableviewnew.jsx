...
const Tableviewnew = ({ fileData, TaskwiseMarks, email }) => {
  ...
  //------------------------------------------------------------------//
  //RenderThirdtable and RenderTestTable//
  //------------------------------------------------------------------//
  ...
  const [goodPotential, setGoodPotential] = useState(initialGoodPotential);
  const [highPotential, setHighPotential] = useState(initialHighPotential);
